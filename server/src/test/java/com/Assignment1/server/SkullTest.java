...
public class SkullTest {
    ...
    public void testRow112(){
    	...
    	String[] dieRoll = {"Monkey", "Monkey", "Monkey", "Sword", "Sword", "Sword", "Skull", "Skull"};
    	String[] dieRollAlt = {"Monkey", "Monkey", "Monkey", "Monkey", "Monkey", "Monkey", "Skull", "Skull"};
